...
void parser::evaluate_exp1(double &result)
{
    int slot;
    char temp_token[80];
...
double parser::evaluate_exp(char *exp)
{
    errormsg[0] = '\0';
    double result;
    expression_ptr = exp;
    ...
    if (*token) // last token must be null
        strcpy(errormsg, "Syntax Error, perhaps you forgot to add * before brackets");
    return result;
}

// Multiplies or divides
void parser::evaluate_exp3(double &result)
{
    register char op;
    double temp;
...
// Adds or subtracts
void parser::evaluate_exp2(double &result)
{
    register char op;
    double temp;
...
// Modulo
void parser::evaluate_exp4(double &result)
{
        double temp;
...
void parser::evaluate_exp5(double &result)
{
    register char op;
    op = 0;
...
void parser::evaluate_exp6(double &result)
{
...
int main()
{
    char expstr[256];
    parser object;
    cout << "Math expression parser. Leave a blank line to stop.\n\n";
    do
    {
